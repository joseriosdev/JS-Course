...
- Should have the next functions:
	...
	8- Knowing the speed and total trip distance, should say the amount of hours taken to complete the trip (fixed to 1)
Create an app that uses all prev functions taking the params from user input
*/